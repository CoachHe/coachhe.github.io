...
[0.173s][info   ][gc,heap,exit ]  garbage-first heap   total 10240K, used 1024K [0x00000007ff600000, 0x0000000800000000)
[0.173s][info   ][gc,heap,exit ]   region size 1024K, 2 young (2048K), 0 survivors (0K)
[0.173s][info   ][gc,heap,exit ]  Metaspace       used 6155K, capacity 6223K, committed 6528K, reserved 1056768K
[0.173s][info   ][gc,heap,exit ]   class space    used 529K, capacity 538K, committed 640K, reserved 1048576K
```
